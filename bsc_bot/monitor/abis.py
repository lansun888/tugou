# PancakeSwap V2 Factory ABI (PairCreated)
...
# PancakeSwap V3 Factory ABI (PoolCreated)
...
# Biswap Factory ABI (PairCreated) - Same as PancakeSwap V2
BISWAP_FACTORY_ABI = PANCAKESWAP_V2_FACTORY_ABI
